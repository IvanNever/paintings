...
var forms = function forms() {
  ...
  var message = {
    loading: 'Загрузка...',
    success: 'Спасибо за обращение! Наш менеджер свяжется с вами в ближайшее время',
...
var modals = function modals() {
  ...
  showModalByScroll('.fixed-gift'); // showModalByTime('.popup-consultation', 60000);
};
...
var scrolling = function scrolling(upSelector) {
  ...
  }); //Scrolling width request animation frame
